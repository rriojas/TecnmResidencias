...
public static class DbSeeder
{
    ...
    public static async Task BootstrapSystemAsync(AppDbContext db, string adminPassword)
    {
        ...
        var permDefs = new List<(string ModuleSlug, string Name, string Slug)>
        {
            ...
            ("admin", "Gestión de Carreras", "admin.careers"),
            ...
            DO $$ BEGIN
                ...
                IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='careers') THEN
                    IF (SELECT COUNT(*) FROM careers) = 0 THEN
                        INSERT INTO careers (id, code, name, acronym, department_id, is_active) VALUES
                ...
                IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='advisor_departments') THEN
                ...
                IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='students') THEN
                    ...
                    END IF;
                    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='students' AND column_name='has_complementary_activities') THEN
                        ALTER TABLE students ADD COLUMN has_complementary_activities boolean NOT NULL DEFAULT false;
                    END IF;
                    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='students' AND column_name='has_social_service') THEN
                        ALTER TABLE students ADD COLUMN has_social_service boolean NOT NULL DEFAULT false;
                    END IF;
                ...
                IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='student_blocks') THEN
                    ...
                    CREATE INDEX IF NOT EXISTS ix_student_blocks_student_id ON student_blocks(student_id);
                    ALTER TABLE student_blocks ADD CONSTRAINT fk_student_blocks_student_id FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE;
                    ALTER TABLE student_blocks ADD CONSTRAINT fk_student_blocks_blocked_by FOREIGN KEY (blocked_by) REFERENCES users(id) ON DELETE RESTRICT;
                    ALTER TABLE student_blocks ADD CONSTRAINT fk_student_blocks_unblocked_by FOREIGN KEY (unblocked_by) REFERENCES users(id) ON DELETE RESTRICT;
                END IF;
                ...
                CREATE TABLE IF NOT EXISTS company_agreements (
                    ...
                    pit_code VARCHAR(20) NULL,
                    cia_type VARCHAR(100) NULL,
                    agreement_scope VARCHAR(50) NULL,
                    sector VARCHAR(50) NULL,
                    business_line VARCHAR(150) NULL,
                    company_size VARCHAR(50) NULL,
                    geographic_scope VARCHAR(50) NULL,
                    notes TEXT NULL,
                    is_active BOOLEAN NOT NULL DEFAULT TRUE,
                    is_visible BOOLEAN NOT NULL DEFAULT TRUE,
                ...
                ALTER TABLE company_agreements ADD COLUMN IF NOT EXISTS archive_id VARCHAR(50) NULL;
                ...
                ALTER TABLE company_agreements ADD COLUMN IF NOT EXISTS pit_code VARCHAR(20) NULL;
                ALTER TABLE company_agreements ADD COLUMN IF NOT EXISTS cia_type VARCHAR(100) NULL;
                ...
                IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='advisory_sessions') THEN
                    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='advisory_sessions' AND column_name='review_status') THEN
                        ALTER TABLE advisory_sessions ADD COLUMN review_status character varying(30) NOT NULL DEFAULT 'pending';
                    END IF;
                    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='advisory_sessions' AND column_name='review_notes') THEN
                        ALTER TABLE advisory_sessions ADD COLUMN review_notes text NULL;
                    END IF;
                    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='advisory_sessions' AND column_name='reviewed_at') THEN
                        ALTER TABLE advisory_sessions ADD COLUMN reviewed_at timestamp with time zone NULL;
                    END IF;
                    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='advisory_sessions' AND column_name='reviewed_by') THEN
                        ALTER TABLE advisory_sessions ADD COLUMN reviewed_by bigint NULL;
                    END IF;
                END IF;
                ...
                ALTER TABLE users ADD COLUMN IF NOT EXISTS last_name_2 VARCHAR(100);
                ALTER TABLE users ADD COLUMN IF NOT EXISTS control_number VARCHAR(20);
                ALTER TABLE users ADD COLUMN IF NOT EXISTS career_id BIGINT;
                ALTER TABLE students ADD COLUMN IF NOT EXISTS phone VARCHAR(30);
                ALTER TABLE student_blocks ADD COLUMN IF NOT EXISTS created_by BIGINT NULL;
                ...
                UPDATE users u SET first_name = s.first_name, last_name = s.last_name_1, last_name_2 = s.last_name_2, control_number = s.control_number, career_id = s.career_id FROM students s WHERE s.user_id = u.id AND u.first_name IS NULL;
                UPDATE students s SET phone = u.phone FROM users u WHERE u.id = s.user_id AND u.phone IS NOT NULL AND (s.phone IS NULL OR s.phone = '');
            END $$;
        ";
        try
        {
